...
void ShenandoahQTableHeuristics::choose_collection_set_from_regiondata(ShenandoahCollectionSet* cset,
                                                                         RegionData* data, size_t size,
                                                                         size_t actual_free) {
  size_t garbage_threshold = ShenandoahHeapRegion::region_size_bytes() * ShenandoahGarbageThreshold / 100;

  // The logic for cset selection in QTable is as follows:
  //
  ...
  log_info(gc, ergo)("QTable CSet Selection. Target Free: " SIZE_FORMAT "%s, Actual Free: "
...
void ShenandoahQTableHeuristics::record_cycle_start() {
